...
P( B given A1 ) = 0.9 [When it rains, the weatherman predicts rain 90% of the time.]

P( B given A2 ) = 0.1 [When it does not rain, the weatherman predicts rain 10% of the time.]"
